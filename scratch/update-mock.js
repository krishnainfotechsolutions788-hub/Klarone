...
const fileContent = `import { Category, Product, ProductVariant, InventoryUnit, InventoryStock, InventoryMovement, ProductImage, VariantImage, InventoryUnitImage } from '../types/inventory';

export const mockCategories: Category[] = [
  { id: 'cat_001', name: 'Laptops', slug: 'laptops', status: 'active' },
  { id: 'cat_002', name: 'Solid State Drives', slug: 'ssd', status: 'active' },
  { id: 'cat_003', name: 'RAM Memory', slug: 'ram', status: 'active' },
  { id: 'cat_004', name: 'Accessories', slug: 'accessories', status: 'active' },
  { id: 'cat_005', name: 'Desktops', slug: 'desktops', status: 'active' },
  { id: 'cat_006', name: 'CCTV Cameras', slug: 'cctv', status: 'active' },
  { id: 'cat_007', name: 'Networking', slug: 'networking', status: 'active' },
];
...
export const mockProducts: Product[] = [
  ...
  {
    id: 'prod_003', category_id: 'cat_002', brand: 'Samsung', series: 'Pro', model_name: '990 Pro 1TB',
  ...
  {
    id: 'prod_012', category_id: 'cat_002', brand: 'Kingston', series: 'A400', model_name: '240GB SATA',
    slug: 'kingston-a400-240gb', description: 'Reliable SATA SSD.', inventory_type: 'NON_SERIALIZED', base_price: 1500, status: 'active',
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(),
  },
  // RAM
  {
    id: 'prod_013', category_id: 'cat_003', brand: 'Corsair', series: 'Vengeance LPX', model_name: '16GB (2x8GB) DDR4',
  ...
  {
    id: 'prod_014', category_id: 'cat_003', brand: 'Crucial', series: 'Basics', model_name: '8GB DDR4 Laptop RAM',
  ...
  {
    id: 'prod_015', category_id: 'cat_003', brand: 'G.Skill', series: 'Trident Z5 RGB', model_name: '32GB DDR5',
...
export const mockProductImages: ProductImage[] = [
  { id: 'img_prod_001', product_id: 'prod_001', image_url: 'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?w=800&q=80', alt_text: 'Lenovo ThinkPad', sort_order: 1, is_primary: true, created_at: new Date().toISOString() },
...
export function getDisplayImages(productId: string, variantId?: string, unitId?: string) {
  if (unitId) {
    ...
    if (unit && unit.has_actual_photos) {
...
console.log("Updated mock-data.ts successfully");
