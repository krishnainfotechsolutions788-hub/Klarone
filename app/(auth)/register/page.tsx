  ...
  if (isSuccess) {
    return (
      <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700 text-center py-10">
        ...
        <h2 className="text-[28px] font-bold tracking-tight text-[#111111]">Account created!</h2>
        <p className="text-[15px] text-slate-500 font-medium max-w-sm mx-auto">
          Welcome to Klarone. You can now log in to view your recommendations and start shopping.
        </p>
        <Link href="/login">
  ...
  return (
    <div className="flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col gap-2">
        <h2 className="text-[32px] font-bold tracking-tight text-[#111111]">Create an account</h2>
        <p className="text-[15px] text-slate-500 font-medium">Get started with smarter technology decisions.</p>
      </div>
        ...
        <div className="flex flex-col gap-2 relative">
          ...
          <div className="relative">
            ...
            <Input 
              ...
              {...register("fullName")}
              className={`pl-10 h-11 bg-slate-50 border-slate-200 focus-visible:ring-[#00A7B5] transition-all ${errors.fullName ? "border-red-500" : ""}`}
            />
          </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button variant="outline" className="h-11 bg-white border-slate-200 hover:bg-slate-50 text-slate-700 font-medium flex items-center justify-center opacity-50 cursor-not-allowed" title="Coming soon">
